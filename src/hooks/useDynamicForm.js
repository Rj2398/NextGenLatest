...
/**
 * 🎣 A globally reusable hook for managing form state and handling dynamic API submission.
...
export default function useDynamicForm(formSchema, initialBaseData = {}) {
    ...
    // 1. --- 🌟 FIELD LOCATION MAP (CRITICAL FOR NEW PAYLOAD FORMAT) 🌟 ---
    ...
    const handleFormSubmission = async (action, { externalBaseData, onSuccessNavigation }) => {
        ...
        try {
            ...
            const result = await submitMutation({
                payload: payload, // 👈 Send the URL-ENCODED STRING
